...
func (r *realTBClient) LookupAccounts(ids []ID128) ([]TBAccount, error) {
	tbIDs := make([]tbtypes.Uint128, len(ids))
	for i, id := range ids {
...
func uint128ToUint64(u tbtypes.Uint128) uint64 {
	b := u.Bytes()
