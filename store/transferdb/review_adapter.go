...
// and the ReviewStore interface (core/recovery) using SQLC-generated queries.
//
...
func NewReviewStoreAdapter(q *Queries) *ReviewStoreAdapter {
	return &ReviewStoreAdapter{q: q}
}
...
func (a *ReviewStoreAdapter) HasActiveReview(ctx context.Context, transferID uuid.UUID) (bool, error) {
	return a.q.HasActiveReview(ctx, transferID)
}
