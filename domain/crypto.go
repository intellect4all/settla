...
type KeyManager interface {
	// GetDEK returns the plaintext DEK for the given tenant.
	// Returns ErrTenantShredded if the tenant's key has been destroyed.
...
// Encrypt encrypts a PII field value for the given tenant.
...
// Decrypt decrypts a PII field value for the given tenant.
